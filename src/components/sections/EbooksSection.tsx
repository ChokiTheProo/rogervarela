...
const translations = {
  pt: {
    ...
    title: 'Landing Pages & Sites em Produção',
    description: 'Projetos reais publicados e em operação para clientes — sites institucionais, landing pages e blogs entregues, indexados e gerando resultado.',
    cta: 'Ver Sites no Ar',
    contact: 'Quero o Meu',
  ...
  en: {
    ...
    title: 'Landing Pages & Sites in Production',
    description: 'Real projects published and operating for clients — institutional sites, landing pages and blogs delivered, indexed and generating results.',
    cta: 'View Live Sites',
    contact: 'I Want Mine',
  ...
  es: {
    ...
    title: 'Landing Pages y Sitios en Producción',
    description: 'Proyectos reales publicados y en operación para clientes — sitios institucionales, landing pages y blogs entregados, indexados y generando resultados.',
