            ...
            >
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-primary-foreground/80 mb-1">{t.revyra}</p>
                    <h4 className="text-2xl font-heading font-bold text-primary-foreground">REVYRA</h4>
